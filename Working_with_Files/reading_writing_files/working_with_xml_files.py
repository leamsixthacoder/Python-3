...
def add_xml_elememt_et(fn, el, attr, val):
    tree = ET.parse(fn)
    root = tree.getroot()        
    child = ET.Element(el)
...
parse_xml_et('ef_author.xml')

# add_xml_elememt_et('ef_author.xml', 'domain', 'name', 'Java')

# change_xml_element_et('ef_author.xml', 'domain', 'name', 'Java', 'TypeScript')